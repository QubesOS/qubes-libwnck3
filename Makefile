...
FEDORA_SOURCES := https://src.fedoraproject.org/rpms/libwnck3/raw/f$(subst fc,,$(DIST))/f/sources
SRC_FILES := \
libwnck-$(VERSION).tar.xz

BUILDER_DIR ?= ../..
SRC_DIR ?= qubes-src

SRC_URLS := \
https://download.gnome.org/sources/libwnck/43/libwnck-$(VERSION).tar.xz
